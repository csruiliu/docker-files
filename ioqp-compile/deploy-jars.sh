...
cp $HOME/Develop/ioqp/relaqs/target/scala-2.11/ruiliu-relaqs_2.11-2.4.0.jar $HOME/Develop/docker-files/ioqp-load/jars/
...
cp $HOME/Develop/ioqp/relaqs/target/scala-2.11/ruiliu-relaqs_2.11-2.4.0.jar $HOME/Develop/docker-files/ioqp-process/jars/

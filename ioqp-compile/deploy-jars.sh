...
docker build -t csruiliu/ioqp-load /home/ruiliu/Develop/docker-files/ioqp-load
docker build -t csruiliu/ioqp-process /home/ruiliu/Develop/docker-files/ioqp-process
